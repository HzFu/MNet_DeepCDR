...
4. The pre-train models *'Model_DiscSeg_ORIGA_pretrain.h5'* and *'Model_MNet_ORIGA_pretrain.h5'*  are trained on **REFUGE dataset**.
...
- 19.01.22: Added training code, and updated model bu using REFUGE dataset.
